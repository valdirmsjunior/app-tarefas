...
<template>
    <tr>
        <td class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 whitespace-nowrap sm:pl-0">{{ props.tarefa.nome }}</td>
        ...
        <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">{{ moment(props.tarefa.vencimento).format("DD/MM/YYYY") }}</td>
